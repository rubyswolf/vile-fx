...
class FxPlugin : public SynthBase, public AudioProcessor, public ValueBridge::Listener {
  public:
    FxPlugin();
    virtual ~FxPlugin();
  ...
  private:
    ...
    vital::poly_float input_frames_[vital::kMaxBufferSize];

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(FxPlugin)
};
