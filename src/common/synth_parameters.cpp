...
namespace vital {
  ...
  const ValueDetails ValueDetailsLookup::parameter_list[] = {
    ...
    { "input_1_source", 0x000800, -1.0, 1.0, 0.0, 0.0, 100.0,
      ValueDetails::kLinear, false, "%", "Input 1 Source", nullptr },
    { "input_1_pan", 0x000800, -1.0, 1.0, 0.0, 0.0, 100.0,
      ValueDetails::kLinear, false, "%", "Input 1 Pan", nullptr },
    { "input_1_width", 0x000800, -1.0, 1.0, 1.0, 0.0, 100.0,
      ValueDetails::kLinear, false, "%", "Input 1 Width", nullptr },
    { "input_1_level", 0x000800, -80.0, 24.0, 0.0, 0.0, 1.0,
      ValueDetails::kLinear, false, " dB", "Input 1 Level", nullptr },
